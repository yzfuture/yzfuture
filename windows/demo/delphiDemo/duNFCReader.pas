...
function cardOpenDevice(szAppkey: PAnsiChar; szAppSecret: PAnsiChar; szServerIp: PAnsiChar; nServerPort: Int32; userData: PAnsiChar; unRecvTimeOut: Integer; nDeviceNo: Integer): Integer; stdcall; external DllName;
