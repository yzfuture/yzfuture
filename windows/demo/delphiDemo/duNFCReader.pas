...
uses
  Controls, Forms, Dialogs, Messages, Classes,
  syncobjs, SysUtils, Windows, jpeg;
...
function loginCardServerEx(szServerIp: PAnsiChar; nServerPort: Int32;nerr: PInteger): Boolean; stdcall; external DllName; // 登录服务器
